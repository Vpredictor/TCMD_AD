...
#--- load the datasets ---
rm(list=ls())
setwd("../Desktop/TCMD/Datasets/original_Dataset/")
...
#------ Visualization  --------
tiff("../Desktop/TCMD/Plots/LandsatSatellite.tiff", units="in", width=8, height=6, res=600)
...
tiff("../Desktop/TCMD/Plots/HAP_sil.tiff", units="in", width=8, height=6, res=600)
...
tiff("../Desktop/TCMD/Plots/satelliteHAP.tiff", units="in", width=8, height=6, res=600)
...
#------ Save The Cluster Label in CSV -----
satellite_dataFrame <- data.frame(satellite_data [,-37] ,  ClusterLabel = Label_HAP)
setwd("../Desktop/TCMD/Datasets/clustered_Dataset")
write.csv(satellite_dataFrame, "satellite-unsupervised-labelled.csv" )
